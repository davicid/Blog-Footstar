...
$sql = "SELECT DATE_FORMAT(c.data_inclusao, '%d %b %Y %T') AS data_inclusao, c.comentario, c.id_usuario, c.id, u.nome FROM comentarios AS c JOIN usuarios AS u WHERE c.id_usuario = u.id AND c.id_noticia = $id_noticia";
